...
class TestCommitAnswerToHistory:
    def setup_method(self):
        ...
        self.orig_store = conversation.store
        new_store = server.ConversationStore(self.tmpdir)
    ...
    def teardown_method(self):
        ...
        import nbti.utils
        import shutil
        conversation.store = self.orig_store
        nbti.utils.store = self.orig_store
    ...
    def _read_data(self, conv_id):
        from nbti import conversation
        return conversation.store._read(conv_id)
